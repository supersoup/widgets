define([
    ...
    $.extend(Transfer.prototype, {
       _init: function (options) {
           ...
           var $transferList = this.$transferList = $wrap.find('.wd-transfer-list');
           var $transferValue = this.$transferValue = $wrap.find('.wd-transfer-value');
           var $add = this.$add = $wrap.find('.wd-transfer-add');
           var $remove = this.$remove = $wrap.find('.wd-transfer-remove');
           var $clear = this.$clear = $wrap.find('.wd-transfer-clear');
